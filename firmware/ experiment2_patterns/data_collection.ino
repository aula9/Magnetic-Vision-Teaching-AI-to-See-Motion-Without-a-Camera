/*
 * motion_pattern_logger.ino
 * 
 * Wio Terminal firmware for recording magnetic motion patterns.
 * Records 300 samples (3 seconds at 100 Hz) and sends them
 * to a PC via Serial for training with Edge Impulse.
 * 
 * Classes: STRAIGHT, OSCILLATE, PAUSE
 * Buttons: B1=Start, B2=Test, B3=Next Class
 */
#include <TFT_eSPI.h>
#include <SPI.h>
...
const String classList[] = {"STRAIGHT", "OSCILLATE", "PAUSE"};
